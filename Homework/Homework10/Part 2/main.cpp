...
Last Update: 5/5/23
Description: A program testing Binary Trees
User Interface: Number of items to insert into the tree
Notes:
*/
...
template <class T> void TreeInfo(BinaryTree<T> &tree) {
    ...
    cout << "Number of leaf nodes in the tree = " << tree.numberOfLeafNodes() << endl;
